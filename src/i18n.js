		...
		resources: {
			en: {
				translation: {
					...
					'home#notification_terms': '<b>Ao carregar em "Tirar Senha"</b>, confirma que leu e compreendeu os',
					'home#notification_termsLink': 'termos e condições da proteção de dados',
...
Lisboa (?), XXX Março 2020
            `,
					...
					'leave#description': 'Já não está inscrito na Fila.<br/>O próximo Cliente agradece.',
					'leave#bye': 'Até breve!',
					'leave#goBack': 'Voltar',
					...
					'admin#recoverPassword_text1': 'Introduza o seu email para recuperar a password',
					'admin#recoverPassword_email': 'Email',
					'admin#recoverPassword_recover': 'Recuperar',
					'admin#recoverPassword_back': 'Retroceder',
					'admin#recoverPassword_serverFail': 'Houve um erro, por favor tente novamente',
					...
					'main#addConsumerPhone_title': 'Insira o número de Telemóvel do cliente',
					...
					'main#addConsumerPhoneSuccess_text': 'Foi enviada uma SMS para o telemóvel do Cliente.',
					...
					'main#endQueueSuccess_text': 'A sua fila foi terminada.<br/>Até Amanhã!',
