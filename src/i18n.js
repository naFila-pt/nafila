      ...
      en: {
        translation: {
          ...
          "about_us#text_illustrations":
            "As ilustrações usadas foram adaptadas, com base no Projecto <b><a href='https://www.humaaans.com/' target='_blank'>humaaans</a></b>, de Pablo Stanley, sob a <b>licença <a href='https://creativecommons.org/licenses/by/4.0/deed.pt' target='_blank'>CC BY 4.0</a></b>.",
          ...
          "about_us#text_support_instructions":
            "Faça aqui o <b>download do cartaz de instruções</b> (<b><a href='{{filepathColorful}}' target='_blank'>versão a cores</a></b> ou <b><a href='{{filepathBlackWhite}}' target='_blank'>versão a preto e branco</a></b>) para colocar à porta do seu estabelecimento.",
          "about_us#title_support_implementation_kit": "Kit de implementação",
          "about_us#text_support_implementation_kit":
            "Faça <b><a href='{{filepath}}' target='_blank'>download do kit de implementação</a></b> do na<b>fila</b> onde poderá ver passo-a-passo como utilizar o nosso sistema de senhas.",
