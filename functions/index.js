...
async function addTicket(
  ...
  await transaction.update(queueRef, {
    ticketTopNumber,
    remainingTicketsInQueue
  });

  return {
    ticketId: ticketRef.id,
    ticketNumber: ticketTopNumber,
    remainingTicketsInQueue: remainingTicketsInQueue
  };
}
